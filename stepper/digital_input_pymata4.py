...
def digital_in(my_board, pin, pins, num_steps, vel):
    """
    ...
    my_board.set_pin_mode_stepper(num_steps, pins)
...
try:
    digital_in(board, DIGITAL_PIN, pins, num_steps, vel)
except KeyboardInterrupt:
    board.shutdown()
    sys.exit(0)
